%This is the manuscript used for implementing ODAELM-T
...
for i=9:9%For testing, only using the first set of training and testing
...
%                     end
    ...
    ErrorSubFolder=['ODAELMT-Error-B',num2str(i)];
    LNumSubFolder=['ODAELMT-LNum-B',num2str(i)];
    TimeSubFolder=['ODAELMT-Time-B',num2str(i)];
