function [TrainingTime,TestingTime,TrainingAccuracy, TestingAccuracy,OutputWeight] = ELM_K(TrainingData,Train_Target, TestingData,Test_Target, Elm_Type, Regularization_coefficient, Kernel_type, Kernel_para)
...
if Elm_Type~=REGRESSION
    ...
    j=1;
    for i = 2:(NumberofTrainingData+NumberofTestingData)    %Counting how many classes
    ...
    T=temp_T*2-1;   %The positive class is -1, and the negative is -1;
    ...
    TV.T=temp_TV_T*2-1;     %Same as last section
                                              %   end if of Elm_Type
end
