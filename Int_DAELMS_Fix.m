%This manuscript is used for implement DAELMS using fixed circle
%Status: tested
...
%     Flag=0;Selected=50;
    ...
    ErrorSubFolder=['DAELMS-Fix-Error-B',num2str(i)];
    LNumSubFolder=['DAELMS-Fix-LNum-B',num2str(i)];
    TimeSubFolder=['DAELMS-Fix-Time-B',num2str(i)];
