%This manuscript is for IntegratedExp and the algorithm is ODAELMS
%Status:tested
...
%                     h=HOutput(dx,IW,Bias',ActType);
    ...
    ErrorSubFolder=['DAELMS-Error-B',num2str(i)];
    LNumSubFolder=['DAELMS-LNum-B',num2str(i)];
    TimeSubFolder=['DAELMS-Time-B',num2str(i)];
