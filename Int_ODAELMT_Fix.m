%This manuscript is used for ODAELMT with fix period
%Status: tested
...
%                     end
    ...
    ErrorSubFolder=['ODAELMT-Fix-Error-B',num2str(i)];
    LNumSubFolder=['ODAELMT-Fix-LNum-B',num2str(i)];
    TimeSubFolder=['ODAELMT-Fix-Time-B',num2str(i)];
