%This manuscript is used for Int_Ensemble_ELM
...
for i=1:9   %For testing, only using the first set of training and testing
    ...
    ErrorSubFolder=['Ensemble-ELM-Error-B',num2str(i)];
    LNumSubFolder=['Ensemble-ELM-LNum-B',num2str(i)];
    TimeSubFolder=['Ensemble-ELM-Time-B',num2str(i)];
